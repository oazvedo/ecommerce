...
namespace api.infra.Migrations
{
    ...
    [Migration("20260810132325_AddProdutoTipoEContratacao")]
    partial class AddProdutoTipoEContratacao
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("api.Domain.Produto", b =>
                {
                    ...
                    b.Property<int>("ContratacaoPermitida")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(3)
                        .HasColumnName("contratacao_permitida")
                        .HasJsonPropertyName("contratacao_permitida");
                    ...
                    b.Property<int>("MaxParcelas")
                        ...
                        .HasJsonPropertyName("max_parcelas");
